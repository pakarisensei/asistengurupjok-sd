document.addEventListener('DOMContentLoaded', () => {
    // --- DATABASE LOKAL ---
    // Menyimpan semua data statis untuk pembuatan modul
    ...
    // --- SELEKSI ELEMEN DOM ---
    // Mengambil semua elemen interaktif dari HTML untuk dimanipulasi
    const domElements = {
    ...
    function showModal(title, content) {
        ...
        // Mengonversi format markdown sederhana (bold dan newline) ke HTML
    ...
    function getFormContext() {
        // Mengambil nilai-nilai penting dari formulir untuk digunakan oleh AI
        return {
    ...
    function setupEventListeners() {
        ...
        // Tombol fitur AI untuk ide pemanasan
        ...
        // Tombol fitur AI untuk materi ajar tambahan
        ...
        // Tombol fitur AI untuk kuis interaktif
        ...
        // Tombol fitur AI untuk ide coding PJOK
        ...
        // Event listener untuk tombol tutup dan salin pada modal
        ...
        // Event listener untuk dropdown formulir yang saling terhubung
    ...
    function generateModuleContent() {
        ...
        // Menampilkan hasil modul ke dalam kontainer output
    ...
    setupEventListeners();
    populateKelas(); // Mengisi dropdown kelas saat halaman pertama kali dimuat
});
